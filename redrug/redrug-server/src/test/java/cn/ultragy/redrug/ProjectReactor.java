...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.ultragy";
    private static final String ARTIFACT_ID = "redrug";
    private static final String PACKAGE_NAME = "cn.ultragy.redrug";
    private static final String TITLE = "药物再利用系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.ultragy";
        String artifactIdNew = "redrug";
        String packageNameNew = "cn.ultragy.redrug";
        String titleNew = "药物再利用系统";
