package cn.ultragy.redrug.module.member.service.user;
...
import cn.ultragy.redrug.module.member.service.auth.MemberAuthServiceImpl;
 ...
 * @author 宋天
 */
@Import({MemberUserServiceImpl.class, RedrugRedisAutoConfiguration.class})
