package cn.ultragy.redrug.module.infra.service.codegen.inner;
...
import cn.ultragy.redrug.framework.excel.core.annotations.DictFormat;
import cn.ultragy.redrug.framework.excel.core.convert.DictConvert;
...
import cn.ultragy.redrug.module.infra.enums.codegen.CodegenSceneEnum;
import cn.ultragy.redrug.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "redrug-module-${table.moduleName}/" + // 顶级模块
                "redrug-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "redrug-module-${table.moduleName}/" + // 顶级模块
                "redrug-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "redrug-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "redrug-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
}
