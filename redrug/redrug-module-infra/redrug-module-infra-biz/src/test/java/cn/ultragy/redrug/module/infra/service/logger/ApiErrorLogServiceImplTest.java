package cn.ultragy.redrug.module.infra.service.logger;
...
import cn.ultragy.redrug.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.ultragy.redrug.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.ultragy.redrug.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.ultragy.redrug.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("redrug-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("redrug-test");
