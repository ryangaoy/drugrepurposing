package cn.ultragy.redrug.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.ultragy.redrug.framework.common.enums.CommonStatusEnum;
import cn.ultragy.redrug.framework.common.exception.ServiceException;
import cn.ultragy.redrug.framework.common.pojo.PageResult;
import cn.ultragy.redrug.framework.common.util.collection.ArrayUtils;
import cn.ultragy.redrug.framework.common.util.collection.CollectionUtils;
import cn.ultragy.redrug.framework.test.core.ut.BaseDbUnitTest;
import cn.ultragy.redrug.module.infra.api.file.FileApi;
import cn.ultragy.redrug.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.ultragy.redrug.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.ultragy.redrug.module.system.controller.admin.user.vo.user.*;
import cn.ultragy.redrug.module.system.dal.dataobject.dept.DeptDO;
import cn.ultragy.redrug.module.system.dal.dataobject.dept.PostDO;
import cn.ultragy.redrug.module.system.dal.dataobject.dept.UserPostDO;
import cn.ultragy.redrug.module.system.dal.dataobject.tenant.TenantDO;
import cn.ultragy.redrug.module.system.dal.dataobject.user.AdminUserDO;
import cn.ultragy.redrug.module.system.dal.mysql.dept.UserPostMapper;
import cn.ultragy.redrug.module.system.dal.mysql.user.AdminUserMapper;
import cn.ultragy.redrug.module.system.enums.common.SexEnum;
import cn.ultragy.redrug.module.system.service.dept.DeptService;
import cn.ultragy.redrug.module.system.service.dept.PostService;
import cn.ultragy.redrug.module.system.service.permission.PermissionService;
import cn.ultragy.redrug.module.system.service.tenant.TenantService;
...
import static cn.ultragy.redrug.framework.common.util.collection.SetUtils.asSet;
import static cn.ultragy.redrug.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.ultragy.redrug.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.ultragy.redrug.framework.common.util.object.ObjectUtils.cloneIgnoreId;
...
import static cn.ultragy.redrug.module.system.enums.ErrorCodeConstants.*;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("redrugyuanma");
        ...
        assertEquals("redrugyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("redrugyuanma"))).thenReturn("java");
