package cn.ultragy.redrug.module.system.service.social;
...
import cn.ultragy.redrug.module.system.dal.dataobject.social.SocialUserBindDO;
import cn.ultragy.redrug.module.system.dal.dataobject.social.SocialUserDO;
import cn.ultragy.redrug.module.system.dal.mysql.social.SocialUserBindMapper;
import cn.ultragy.redrug.module.system.dal.mysql.social.SocialUserMapper;
import cn.ultragy.redrug.module.system.enums.social.SocialTypeEnum;
...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    @Resource// 由于自定义了 RedrugAuthRequestFactory 无法覆盖默认的 AuthRequestFactory，所以只能注入它
    private RedrugAuthRequestFactory redrugAuthRequestFactory;
    ...
    public String getAuthorizeUrl(Integer type, String redirectUri) {
        ...
        AuthRequest authRequest = redrugAuthRequestFactory.get(SocialTypeEnum.valueOfType(type).getSource());
        // 生成跳转地址
