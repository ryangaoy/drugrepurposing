package cn.ultragy.redrug.framework.websocket.core;
...
public class RedrugWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public RedrugWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
