package cn.ultragy.redrug.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import cn.ultragy.redrug.framework.social.core.enums.AuthExtendSource;
import cn.ultragy.redrug.framework.social.core.request.AuthWeChatMiniAppRequest;
 ...
 * @date 2021-10-31
 */
public class RedrugAuthRequestFactory extends AuthRequestFactory {
    ...
    public RedrugAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
