 ...
 *      1）Spring Async：
 *          {@link cn.ultragy.redrug.framework.quartz.config.RedrugAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 RedrugSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.ultragy.redrug.framework.tenant;
