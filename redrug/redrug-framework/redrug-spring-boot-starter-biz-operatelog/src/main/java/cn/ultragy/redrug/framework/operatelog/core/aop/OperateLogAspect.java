package cn.ultragy.redrug.framework.operatelog.core.aop;
...
import cn.ultragy.redrug.framework.common.util.monitor.TracerUtils;
import cn.ultragy.redrug.framework.common.util.servlet.ServletUtils;
import cn.ultragy.redrug.framework.operatelog.core.enums.OperateTypeEnum;
import cn.ultragy.redrug.framework.operatelog.core.service.OperateLog;
import cn.ultragy.redrug.framework.operatelog.core.service.OperateLogFrameworkService;
import cn.ultragy.redrug.framework.web.core.util.WebFrameworkUtils;
...
import static cn.ultragy.redrug.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static cn.ultragy.redrug.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        cn.ultragy.redrug.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                cn.ultragy.redrug.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         cn.ultragy.redrug.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           cn.ultragy.redrug.framework.operatelog.core.annotations.OperateLog operateLog,
