package cn.ultragy.redrug.framework.tracer.config;

import cn.ultragy.redrug.framework.common.enums.WebFilterOrderEnum;
import cn.ultragy.redrug.framework.tracer.core.aop.BizTraceAspect;
import cn.ultragy.redrug.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "redrug.tracer", value = "enable", matchIfMissing = true)
public class RedrugTracerAutoConfiguration {
