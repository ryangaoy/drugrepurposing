            ...
            <List<pdbType>
              ...
              renderItem={(item, index) => (
                <List.Item key={item.id}>
                  <Descriptions bordered layout={'vertical'}>
                    <Descriptions.Item label="PDB ID">{item.pdb}</Descriptions.Item>
                    <Descriptions.Item label="Name">{item.proteinNames}</Descriptions.Item>
                    <Descriptions.Item label="Uniprot ID">{item.uniprotId}</Descriptions.Item>
                    <Descriptions.Item label="Length">{item.lengths}</Descriptions.Item>
                    <Descriptions.Item label="EC Number">{item.ecNumber}</Descriptions.Item>
                    <Descriptions.Item label="Gene">{item.geneNames}</Descriptions.Item>
