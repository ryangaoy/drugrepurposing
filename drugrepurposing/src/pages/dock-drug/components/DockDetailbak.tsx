...
const DockDetail: React.FC = () => {
  ...
  return (
    <PageContainer>
      <GridContent>
        <Card title="名称和分类" style={{ marginBottom: 24 }}>
          <Row>
            <Col span={9}>
              <ProCard
            ...
            <Col span={15}>
              ...
              >
                <Descriptions bordered layout={'vertical'}>
                  ...
                  <Descriptions.Item label="PDB ID">{pdbData.pdb}</Descriptions.Item>
                  <Descriptions.Item label="Name">{pdbData.proteinNames}</Descriptions.Item>
                  <Descriptions.Item label="Uniprot ID">{pdbData.uniprotId}</Descriptions.Item>
                  <Descriptions.Item label="Length">{pdbData.lengths}</Descriptions.Item>
                  <Descriptions.Item label="EC Number">{pdbData.ecNumber}</Descriptions.Item>
                  <Descriptions.Item label="Gene">{pdbData.geneNames}</Descriptions.Item>
                </Descriptions>
                <Space wrap>
                  <Button
                    type="primary"
        ...
        <Card title="靶点信息" style={{ marginBottom: 24 }} bordered={false}>
          <Descriptions bordered layout={'vertical'}>
            <Descriptions.Item label="Entry">{pdbData.entrys}</Descriptions.Item>
            <Descriptions.Item label="Organism">{pdbData.organism}</Descriptions.Item>
            <Descriptions.Item label="Function">{pdbData.functions}</Descriptions.Item>
            <Descriptions.Item label="Pubmed ID">{pdbData.pubmedId}</Descriptions.Item>
          </Descriptions>
        </Card>
      </GridContent>
    </PageContainer>
