export default {
  ...
  'pages.menu.titleDesc': 'Drugs',
  'pages.menu.input': 'Input',
  'pages.menu.search': 'Search',
  ...
  'pages.prodescriptions.docktitle': 'Molecular docking results',
  'pages.prodescriptions.info': 'Information',
};
